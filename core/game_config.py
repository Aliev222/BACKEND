...
MAX_REAL_CLICKS_PER_SECOND = 25
CLICK_BURST_ALLOWANCE = 15
MAX_CLICK_BATCH_SIZE = 200
INITIAL_CLICK_BATCH_ALLOWANCE = 12
CLICK_TIME_ACCUMULATION_CAP_SECONDS = 1.5
CLICK_SUSPICIOUS_OVERSHOOT = 25
CLICK_SUSPICION_SOFT_LIMIT = 3
